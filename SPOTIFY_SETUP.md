...
6. Copy the **Client ID** and **Client Secret** (you have to click "View client secret").
    * Paste these into lines 16-17 of `src/main.cpp`.
...
6. The script will print your **Refresh Token**.
   * Paste this into line 18 of `src/main.cpp`.

## Step 3: Add WiFi & Build
1. Add your home `YOUR_WIFI_SSID` and `YOUR_WIFI_PASSWORD` to lines 14-15 of `src/main.cpp`.
